...
export default function Login() {
  ...
  async function handleSubmitWithPin(pinValue) {
    if (!employeeId.trim()) return toast.error('Enter your Employee ID first')
    setLoading(true)
    try {
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm p-8">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">MiniMart</h1>
          <p className="text-slate-400 text-sm mt-0.5">Mining Site Store</p>
        </div>
