    ...
    <div style={{ background: T.bg, fontFamily: FONT, paddingBottom: 100 }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              ...
              <div style={{ textAlign: 'right' }}>
                <div style={{ color: T.ink3, fontSize: 11, fontWeight: 600, textTransform: 'uppercase' }}>ORDERS</div>
      ...
      {products.length > 0 && (
        <>
          <div style={{ padding: '0 20px 12px', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div style={{ color: T.ink, fontSize: 18, fontWeight: 700, letterSpacing: -0.2 }}>In stock today</div>
          </div>
                ...
                <div key={p.id} style={{
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ color: T.ink3, fontSize: 12, marginTop: 2 }}>
                      {p.unit}
                      {lowStock && (
                        <span style={{ color: T.warn, marginLeft: 6 }}>· {p.stock} left</span>
                      )}
                    </div>
                  </div>
      ...
      {!loading && products.length === 0 && (
        <div style={{ textAlign: 'center', padding: '60px 20px', color: T.ink3 }}>
          ...
          <div style={{ marginTop: 12, fontSize: 16 }}>No products available yet</div>
        </div>
      )}
    </div>
  )
